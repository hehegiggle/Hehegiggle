...
export const REQ_USER_REELS = "REQ_USER_REELS";


export const REQ_USER_REELS_SUCCESS = "REQ_USER_REELS_SUCCESS";
export const REQ_USER_REELS_FAILURE = "REQ_USER_REELS_FAILURE";
export const REQ_USER_REELS_REQUEST = "REQ_USER_REELS_REQUEST";
...
export const DISLIKE_REEL_FAILURE = "DISLIKE_REEL_FAILURE";
export const DISLIKE_REEL_SUCCESS = "DISLIKE_REEL_SUCCESS";
export const DISLIKE_REEL_REQUEST = "DISLIKE_REEL_REQUEST";