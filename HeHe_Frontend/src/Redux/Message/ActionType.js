...
export const DELETE_CHAT_ALL_MESSAGES_REQUEST = "DELETE_CHAT_ALL_MESSAGES_REQUEST";
export const DELETE_CHAT_ALL_MESSAGES_SUCCESS = "DELETE_CHAT_ALL_MESSAGES_SUCCESS";
export const DELETE_CHAT_ALL_MESSAGES_FAILURE = "DELETE_CHAT_ALL_MESSAGES_FAILURE";
